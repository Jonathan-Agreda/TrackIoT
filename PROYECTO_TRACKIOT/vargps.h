...
String apiDevicesGps = "http://135.148.148.73:3000/api/devicesgps/2";
String apiDevicesPanico = "http://135.148.148.73:3000/api/devicespanico/2";
String bus = "efgh-5678"; 
int periodoGpsPut = 3000; unsigned long TiempoAhoraGpsPut = 0;
